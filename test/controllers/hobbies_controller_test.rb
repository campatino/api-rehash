...
class HobbiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hobby" do
    assert_difference('Hobby.count') do
      post hobbies_url, params: { hobby: { name: @hobby.name, user_id: @hobby.user_id } }, as: :json
    end
  ...
  test "should update hobby" do
    patch hobby_url(@hobby), params: { hobby: { name: @hobby.name, user_id: @hobby.user_id } }, as: :json
    assert_response 200
  end
